...
$total_resolved = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as c FROM tickets WHERE status='Resolved'"))['c'];
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Profil Admin - Ticketing TVRI</title>
        ...
        <div class="profile-layout">
                ...
                <div class="profile-card-body">
                    ...
                    <div class="view-section" id="viewPersonal">
                        ...
                        <div class="info-grid">
                            ...
                            <div class="info-item"><div class="info-label">Role</div><div class="info-value">Administrator</div></div>
            ...
            <div class="right-col">
                <div class="card-panel">
                    <div class="card-panel-title"><i class="bi bi-bar-chart-line"></i> Statistik Sistem</div>
                    <div class="stats-grid">
                        <div class="stat-box"><div class="stat-icon" style="background:#eff6ff;color:#10367D"><i class="bi bi-people-fill"></i></div><div class="stat-num" style="color:#10367D"><?= $total_users ?></div><div class="stat-lbl">Total User</div></div>
                        <div class="stat-box"><div class="stat-icon" style="background:#fef3c7;color:#f59e0b"><i class="bi bi-ticket-perforated-fill"></i></div><div class="stat-num" style="color:#f59e0b"><?= $total_tickets ?></div><div class="stat-lbl">Total Tiket</div></div>
                        <div class="stat-box"><div class="stat-icon" style="background:#fef2f2;color:#ef4444"><i class="bi bi-exclamation-circle-fill"></i></div><div class="stat-num" style="color:#ef4444"><?= $open_count ?></div><div class="stat-lbl">Open</div></div>
                        <div class="stat-box"><div class="stat-icon" style="background:#f0fdf4;color:#22c55e"><i class="bi bi-check-circle-fill"></i></div><div class="stat-num" style="color:#22c55e"><?= $total_resolved ?></div><div class="stat-lbl">Resolved</div></div>
                    </div>
                </div>
                <div class="card-panel">
